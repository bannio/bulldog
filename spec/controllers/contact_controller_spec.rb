...
describe ContactsController do
  ...
  describe "POST#create" do
    ...
    context "with full valid attributes" do
      it "assigns a new contact" do
        post :create, contact: valid_attrs
        expect(assigns(:contact)).to be_an_instance_of(Contact)
      end
      it "sends an email" do
        expect{ post :create, contact: valid_attrs }.
    ...
    context "with mail_only? true" do
      it "adds to mail list" do
        ...
        post :create, contact: valid_attrs.merge(message: "")
      end
      it "does not send an email" do
        expect{ post :create, contact: valid_attrs.merge(message: "") }.
    ...
    context "with message_only? true" do
      it "does not add to mail list" do
        ...
        post :create, contact: valid_attrs.merge(mail_list: "0")
      end
      it "does send an email" do
        expect{ post :create, contact: valid_attrs.merge(mail_list: "0") }.
         to change { ActionMailer::Base.deliveries.count }.by(1)
      end
      it "redirects to home path" do
        post :create, contact: valid_attrs.merge(mail_list: "0")
